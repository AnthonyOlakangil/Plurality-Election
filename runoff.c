...
void tabulate(void)
{
    ...
    {
        for (int k = 0; k < candidate_count;
             k++) // iterate through the preferences to find the highest preference candidate who is not eliminated
        {
...
// Return true if the election is tied between all candidates (who aren't eliminated), false otherwise
bool is_tie(int min)
{
    for (int i = 0; i < candidate_count; i++)
    {
